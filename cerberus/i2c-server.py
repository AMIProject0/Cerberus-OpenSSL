...
# print(public_key.public_bytes(serialization.Encoding.Raw, serialization.PublicFormat.Raw))
# print(f"Server's Public Key in DER Format: {server_public_der}")
# print(f"Server's Public Key in PEM Format: {server_public_pem}")
# print(f"Server's Private Key in PEM Format: {server_private_pem}")
